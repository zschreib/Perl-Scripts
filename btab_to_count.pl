...
=head1  OUTPUT
        Tab file showing all ORF positions  and how many times all ORFs occur at that position
...
die "Missing input btab file! -i1\n" unless $options{input};
##end error
...
while (<IN>){
	...
	$hoh{$ctgid}{'EVAL'}[$position-1] = $eval;
